...
/* harmony import */ var _config_c0861d87_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(30736);
...
/* harmony import */ var _pipStore_5d9dd8bf_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(21237);
/* harmony import */ var _breakout_rooms_49baca94_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(74912);
/* harmony import */ var _flags_d6a1a11a_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(59348);
...
const getIconPack = async (url) => {
  ...
  if (url == null) {
    return _default_icon_pack_c953657b_js__WEBPACK_IMPORTED_MODULE_3__.d;
  }
  try {
    ...
    return Object.assign({}, _default_icon_pack_c953657b_js__WEBPACK_IMPORTED_MODULE_3__.d, await res.json());
  }
  catch (_) {
    return _default_icon_pack_c953657b_js__WEBPACK_IMPORTED_MODULE_3__.d;
  }
...
const DyteMeeting = class {
  ...
  connectedCallback() {
    ...
    if (this.applyDesignSystem &&
      ...
      (0,_config_c0861d87_js__WEBPACK_IMPORTED_MODULE_1__.p)(document.documentElement, this.config.designTokens);
    }
  ...
  meetingChanged(meeting) {
    ...
    if (this.loadConfigFromPreset && meeting.self.config != null) {
      ...
      const { config, data } = (0,_config_c0861d87_js__WEBPACK_IMPORTED_MODULE_1__.g)(theme, meeting);
  ...
  setStates(states) {
    ...
    (0,_config_c0861d87_js__WEBPACK_IMPORTED_MODULE_1__.m)(newStates, states);
