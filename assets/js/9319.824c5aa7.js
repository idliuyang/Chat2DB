...
/* harmony import */ var _config_534bc18f_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(50935);
/* harmony import */ var _index_b05ec9b1_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(69750);
/* harmony import */ var _default_icon_pack_c9c572ff_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(82324);
...
const getIconPack = async (url) => {
  ...
  if (url == null) {
    return _default_icon_pack_c9c572ff_js__WEBPACK_IMPORTED_MODULE_3__.d;
  }
  try {
    ...
    return Object.assign({}, _default_icon_pack_c9c572ff_js__WEBPACK_IMPORTED_MODULE_3__.d, await res.json());
  }
  catch (_) {
    return _default_icon_pack_c9c572ff_js__WEBPACK_IMPORTED_MODULE_3__.d;
  }
...
const DyteMeeting = class {
  constructor(hostRef) {
    ...
    this.iconPack = _default_icon_pack_c9c572ff_js__WEBPACK_IMPORTED_MODULE_3__.d;
  }
  connectedCallback() {
    var _a;
    ...
    if (this.applyDesignSystem &&
      ...
      (0,_config_534bc18f_js__WEBPACK_IMPORTED_MODULE_1__.p)(document.documentElement, this.config.designTokens);
    }
  ...
  meetingChanged(meeting) {
    ...
    if (this.loadConfigFromPreset && meeting.self.config != null) {
      ...
      const { config, data } = (0,_config_534bc18f_js__WEBPACK_IMPORTED_MODULE_1__.g)(theme);
      if (this.config === _default_ui_config_5abaa842_js__WEBPACK_IMPORTED_MODULE_4__.d) {
  ...
  setStates(states) {
    ...
    (0,_config_534bc18f_js__WEBPACK_IMPORTED_MODULE_1__.m)(newStates, states);
