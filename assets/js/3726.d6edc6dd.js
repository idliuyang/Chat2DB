...
/* harmony import */ var _index_b596e873_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(16619);
/* harmony import */ var _chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(41280);
...
/* harmony import */ var _index_37247bff_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(85371);
...
const DyteChat = class {
  constructor(hostRef) {
    ...
    this.updateRecipients = (event) => {
      ...
      if (this.chatRecipientId !== 'everyone') {
        ...
        const targetKey = (0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_3__.g)(allParticipants);
    ...
    this.onChannelChanged = (e) => {
      if (e.detail.includes(_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_3__.T)) {
        this.createDMChannel(e.detail.replace(_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_3__.T, ''));
      }
      else {
    ...
    this.onChannelCreateOrUpdate = (channel) => {
      ...
      const channels = Array.from(this.channelMap.values())
        .filter((channel) => !(0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_3__.i)(channel))
        .sort((a, b) => (0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_3__.d)(a.displayName, b.displayName));
      const membersWithChannel = Array.from(this.channelMap.values())
        .filter(_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_3__.i)
        .map((channel) => {
      ...
      const membersWithoutChannel = this.meeting.participants.all
        ...
        if (member.userId === this.meeting.self.userId)
          return false;
        const matcher = (0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_3__.e)([this.meeting.self.userId, member.userId]);
        return membersWithChannel.every((channel) => (0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_3__.e)(channel.memberIds) !== matcher);
      })
        .map((member) => {
        return {
          id: `${_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_3__.T}${member.userId}`,
      ...
      const dms = [...membersWithChannel, ...membersWithoutChannel].sort((a, b) => (0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_3__.d)(a.displayName, b.displayName));
    ...
    this.t = (0,_index_b596e873_js__WEBPACK_IMPORTED_MODULE_2__.u)();
  ...
  connectedCallback() {
    ...
    if (this.isFileMessagingAllowed()) {
      ...
      this.host.addEventListener('drop', (e) => {
        e.preventDefault();
        this.dropzoneActivated = false;
        (0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_3__.h)(e.dataTransfer.items, (type, file) => {
          var _a, _b, _c, _d;
          switch (type) {
            case 'image':
              if (this.isFileMessagingAllowed()) {
  ...
  meetingChanged(meeting, oldMeeting) {
    ...
    if (meeting != null) {
      ...
      if (this.isChatViewType) {
        ...
        const validChannels = this.channels.filter((channel) => !channel.id.includes(_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_3__.T));
  ...
  chatGroupsChanged(chatGroups) {
    ...
    for (const key in chatGroups) {
      ...
      if (key ===
        (0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_3__.g)([this.meeting.self.userId, (_b = this.selectedParticipant) === null || _b === void 0 ? void 0 : _b.userId]) ||
  ...
  addToChatGroup(message) {
    var _a;
    const parsedMessage = (0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_3__.p)(message);
    let key = 'everyone';
    if (((_a = parsedMessage.targetUserIds) === null || _a === void 0 ? void 0 : _a.length) > 0) {
      ...
      key = (0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_3__.g)(Array.from(allParticipants));
    }
  ...
  renderComposerUI() {
    ...
    return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-chat-composer-ui", Object.assign({ canSendTextMessage: this.isTextMessagingAllowed(), canSendFiles: this.isFileMessagingAllowed(), disableEmojiPicker: !!((_b = (_a = this.meeting) === null || _a === void 0 ? void 0 : _a.__internals__) === null || _b === void 0 ? void 0 : _b.features.hasFeature(_flags_33c46e09_js__WEBPACK_IMPORTED_MODULE_5__.F.DISABLE_EMOJI_PICKER)), members: this.meeting.participants.all.toArray(), prefill: prefill, channelId: this.selectedChannelId, onDyteNewMessage: this.onNewMessageHandler, onDyteEditMessage: this.onEditMessageHandler, onDyteEditCancelled: () => (this.editingMessage = null) }, uiProps), this.replyMessage && ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "quoted-message-container", slot: "chat-addon" }, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "quoted-message scrollbar" }, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_TextMessage_0a552b96_js__WEBPACK_IMPORTED_MODULE_6__.T, { message: this.replyMessage.message })), (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { "aria-label": this.t('dismiss'), class: "dismiss", icon: this.iconPack.dismiss, onClick: () => (this.replyMessage = null), iconPack: this.iconPack, t: this.t }))))));
  }
  renderFullChat() {
...
const DyteParticipants = class {
  ...
  render() {
    ...
    return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "search", part: "search" }, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.search, part: "search-icon", iconPack: this.iconPack, t: this.t }), (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { type: "search", autocomplete: "off", placeholder: "Search", onInput: this.onSearchInput, part: "search-input" })), (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "ctr scrollbar", part: "container" }, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_37247bff_js__WEBPACK_IMPORTED_MODULE_11__.R, { element: "dyte-participants-waiting-list", defaults: defaults }), (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_37247bff_js__WEBPACK_IMPORTED_MODULE_11__.R, { element: "dyte-participants-stage-queue", defaults: defaults }), (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_37247bff_js__WEBPACK_IMPORTED_MODULE_11__.R, { element: "dyte-participants-stage-list", defaults: defaults, props: { search: this.search } }), (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_37247bff_js__WEBPACK_IMPORTED_MODULE_11__.R, { element: "dyte-participants-viewer-list", defaults: defaults, props: { search: this.search } }))));
  }
  static get watchers() { return {
    "meeting": ["meetingChanged"]
  }; }
