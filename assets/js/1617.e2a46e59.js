...
/* harmony import */ var _default_icon_pack_c953657b_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(92681);
/* harmony import */ var _index_b05ec9b1_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(69750);
/* harmony import */ var _chat_0611caa4_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(62270);
...
/* harmony import */ var _date_8c24cfe1_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(72729);
/* harmony import */ var _scroll_8cc79809_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(82321);
...
const DyteChatComposerUi = class {
  constructor(hostRef) {
    ...
    this.onPaste = (e) => {
      ...
      (0,_chat_0611caa4_js__WEBPACK_IMPORTED_MODULE_5__.h)(data.items, this.sendFile);
    };
    ...
    this.initializeTextField = (el) => {
      this.$textArea = el;
      const message = _graceful_storage_33bc316d_js__WEBPACK_IMPORTED_MODULE_6__.g.getItem('dyte-text-message') || '';
      this.$textArea.value = message;
    };
    this.canSendTextMessage = false;
    this.canSendFiles = false;
    this.size = undefined;
    this.iconPack = _default_icon_pack_c953657b_js__WEBPACK_IMPORTED_MODULE_3__.d;
    this.t = (0,_index_b05ec9b1_js__WEBPACK_IMPORTED_MODULE_4__.u)();
  ...
  handleSendMessage() {
    ...
    if (message.length > 0) {
      ...
      this.$textArea.value = '';
      this.$textArea.style.height = 'auto';
      _graceful_storage_33bc316d_js__WEBPACK_IMPORTED_MODULE_6__.g.setItem('dyte-text-message', '');
    }
  }
  uploadFile(type) {
  ...
  render() {
    ...
    return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.H, null, this.canSendTextMessage && this.emojiPickerActive && ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-emoji-picker", { part: "emoji-picker", onDyteEmojiClicked: (e) => {
        ...
        _graceful_storage_33bc316d_js__WEBPACK_IMPORTED_MODULE_6__.g.setItem('dyte-text-message', e.target.value);
...
const DyteChatMessagesUi = class {
  constructor(hostRef) {
    ...
    this.scrollToBottom = () => {
      (0,_scroll_8cc79809_js__WEBPACK_IMPORTED_MODULE_8__.s)(this.$chat);
    };
  ...
  componentDidRender() {
    if (this.autoScrollEnabled) {
      ...
      (0,_scroll_8cc79809_js__WEBPACK_IMPORTED_MODULE_8__.s)(this.$chat, false);
    }
  }
    ...
    return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "chat-container scrollbar", ref: (el) => (this.$chat = el), part: "container" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "spacer", part: "spacer" }), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "chat", part: "chat" }, (_a = this.messages) === null || _a === void 0 ? void 0 : _a.map((item) => {
      if (item.type === 'chat') {
        ...
        const isContinued = !isUnread &&
          ...
          (0,_date_8c24cfe1_js__WEBPACK_IMPORTED_MODULE_9__.d)(message.time, prevMessage === null || prevMessage === void 0 ? void 0 : prevMessage.time) < 2;
        prevMessage = message;
        switch (message.type) {
          case 'text':
...
const DyteChatSelectorUi = class {
  ...
  render() {
    ...
    return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "chat-scope-selector" }, this.showParticipantsPanel && ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "participants-container" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "search", part: "search" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.search, part: "search-icon" }), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { type: "search", autocomplete: "off", placeholder: "Search", value: this.query, onInput: (e) => {
      ...
      const count = this.unreadCounts[(0,_chat_0611caa4_js__WEBPACK_IMPORTED_MODULE_5__.g)([this.selfUserId, group.userId])];
