...
/* harmony import */ var _chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(41280);



const KNOWN_TAGS = ['<a>', '<b>', '<i>', '<q>', '<s>'];
function parseRichText(text) {
  let boldText = _chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_1__.j.exec(text);
  while (boldText) {
    text = text.replace(boldText[0], `<b>${boldText[1]}</b>`);
    boldText = _chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_1__.j.exec(text);
  }
  let italicsText = _chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_1__.k.exec(text);
  while (italicsText) {
    text = text.replace(italicsText[0], `<i>${italicsText[1]}</i>`);
    italicsText = _chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_1__.k.exec(text);
  }
  let strikethroughText = _chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_1__.l.exec(text);
  while (strikethroughText) {
    text = text.replace(strikethroughText[0], `<s>${strikethroughText[1]}</s>`);
    strikethroughText = _chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_1__.l.exec(text);
  }
  text = text
    .split(' ')
    .map((word) => {
    if (_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_1__.m.test(word)) {
      const res = _chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_1__.m.exec(word);
...
const renderLink = (content) => {
  let link = content;
  if (_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_1__.n.test(link)) {
    link = `mailto:${link}`;
  }
  ...
  return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("a", { class: "link", href: link, target: "_blank", rel: "noopener noreferrer" }, content));
};
...
const TextMessageView = ({ message }) => {
  const withReply = (0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_1__.f)(message, true);
  const withoutReply = (0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_1__.s)(message);
...
/* harmony import */ var _index_b596e873_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(16619);
/* harmony import */ var _graceful_storage_33bc316d_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(60804);
/* harmony import */ var _TextMessage_0a552b96_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(86531);
/* harmony import */ var _chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(41280);
...
/* harmony import */ var _index_37247bff_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(85371);
...
const DyteChannelDetails = class {
  constructor(hostRef) {
    ...
    this.t = (0,_index_b596e873_js__WEBPACK_IMPORTED_MODULE_4__.u)();
  ...
  constructor(hostRef) {
    ...
    this.renderRecentMessage = (channel) => {
      ...
      if (channel.latestMessage.type === 'text') {
        return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { class: "latest-msg" }, senderFragment, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_TextMessage_0a552b96_js__WEBPACK_IMPORTED_MODULE_6__.T, { message: channel.latestMessage.message })));
      }
      // non text
      let messageFragment = '';
...
const DyteChatComposerUi = class {
  constructor(hostRef) {
    ...
    this.handleKeyUp = (_e) => {
      if (this.mentionQuery !== '') {
        const reversed = (0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_7__.r)(this.$textArea.value.trim());
        const query = reversed.substring(0, reversed.indexOf(MENTION_CHAR));
        this.mentionQuery = `${MENTION_CHAR}${(0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_7__.r)(query)}`;
      }
    };
    this.onPaste = (e) => {
      const data = e.clipboardData || e.originalEvent.clipboardData;
      (0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_7__.h)(data.items, this.generateFilePreview);
      (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.w)(() => {
    ...
    this.handleEditMessage = () => {
      ...
      if (((_a = this.prefill.editMessage) === null || _a === void 0 ? void 0 : _a.message) &&
        _chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_7__.o.test(this.prefill.editMessage.message)) {
        // add back the reply block which we stripped out for editing
        const replyBlock = (0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_7__.f)(this.prefill.editMessage.message);
    ...
    this.onMemberSelect = (member) => {
      const reversedQuery = (0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_7__.r)(this.mentionQuery);
      const reversed = (0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_7__.r)(this.$textArea.value.trim()).replace(reversedQuery, '');
      this.$textArea.value = (0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_7__.r)(reversed) + `${MENTION_CHAR}${member.name} `;
      this.mentionQuery = '';
      this.focusedMemberIndex = 0;
  ...
  render() {
    ...
    let defaultValue = '';
    if ((_a = this.prefill.editMessage) === null || _a === void 0 ? void 0 : _a.message) {
      defaultValue = (0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_7__.s)(this.prefill.editMessage.message);
    }
...
const DyteChatSelectorUi = class {
  ...
  render() {
    ...
    return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "chat-scope-selector" }, this.showParticipantsPanel && ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "participants-container" }, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "search", part: "search" }, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.search, part: "search-icon" }), (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { type: "search", autocomplete: "off", placeholder: "Search", value: this.query, onInput: (e) => {
      ...
      const count = this.unreadCounts[(0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_7__.g)([this.selfUserId, group.userId])];
...
const DyteDialogManager = class {
  ...
  render() {
    ...
    if ((states === null || states === void 0 ? void 0 : states.image) != null) {
      ...
      return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-dialog", { open: true, onDyteDialogClose: onImageClose, hideCloseButton: true, iconPack: this.iconPack, t: this.t }, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_37247bff_js__WEBPACK_IMPORTED_MODULE_10__.R, { element: "dyte-image-viewer", defaults: defaults, props: { image, onClose: onImageClose } }))));
    }
    else if ((states === null || states === void 0 ? void 0 : states.activeSettings) === true) {
      return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-dialog", { open: true, onDyteDialogClose: () => this.onDyteDialogClose('activeSettings', false), iconPack: this.iconPack, t: this.t }, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_37247bff_js__WEBPACK_IMPORTED_MODULE_10__.R, { element: "dyte-settings", defaults: defaults }))));
    }
    else if ((states === null || states === void 0 ? void 0 : states.activeDebugger) === true) {
      return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-dialog", { open: true, onDyteDialogClose: () => this.onDyteDialogClose('activeDebugger', false), iconPack: this.iconPack, t: this.t }, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_37247bff_js__WEBPACK_IMPORTED_MODULE_10__.R, { element: "dyte-debugger", defaults: defaults }))));
    }
    else if ((states === null || states === void 0 ? void 0 : states.activeLeaveConfirmation) === true) {
      return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-dialog", { open: true, onDyteDialogClose: () => this.onDyteDialogClose('activeLeaveConfirmation', false), iconPack: this.iconPack, t: this.t }, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_37247bff_js__WEBPACK_IMPORTED_MODULE_10__.R, { element: "dyte-leave-meeting", defaults: defaults }))));
    }
    else if (((_a = states === null || states === void 0 ? void 0 : states.activePermissionsMessage) === null || _a === void 0 ? void 0 : _a.enabled) === true) {
      return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-dialog", { open: true, onDyteDialogClose: () => this.onDyteDialogClose('activePermissionsMessage', { enabled: false }), iconPack: this.iconPack, t: this.t }, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_37247bff_js__WEBPACK_IMPORTED_MODULE_10__.R, { element: "dyte-permissions-message", defaults: defaults }))));
    }
    else if ((states === null || states === void 0 ? void 0 : states.activeRemoteAccessManager) === true) {
      return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-dialog", { open: true, onDyteDialogClose: () => this.onDyteDialogClose('activeRemoteAccessManager', false), iconPack: this.iconPack, t: this.t }, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_37247bff_js__WEBPACK_IMPORTED_MODULE_10__.R, { element: "dyte-remote-access-manager", defaults: defaults }))));
    }
      ...
      return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-dialog", { open: true, onDyteDialogClose: () => this.onDyteDialogClose('activeBreakoutRoomsManager', {
          active: false,
          data: undefined,
        }), iconPack: this.iconPack, t: this.t }, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_37247bff_js__WEBPACK_IMPORTED_MODULE_10__.R, { element: "dyte-breakout-rooms-manager", defaults: defaults, props: { mode: this.meeting.connectedMeetings.isActive ? 'view' : 'create' } }))));
    }
    else if (((_c = states === null || states === void 0 ? void 0 : states.activeConfirmationModal) === null || _c === void 0 ? void 0 : _c.active) === true) {
      return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-dialog", { open: true, onDyteDialogClose: () => this.onDyteDialogClose('activeConfirmationModal', false), iconPack: this.iconPack, t: this.t }, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_37247bff_js__WEBPACK_IMPORTED_MODULE_10__.R, { element: "dyte-confirmation-modal", defaults: defaults }))));
    }
      ...
      return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-dialog", { open: true, onDyteDialogClose: () => this.onDyteDialogClose('activeBroadcastMessageModal', false), iconPack: this.iconPack, t: this.t }, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_37247bff_js__WEBPACK_IMPORTED_MODULE_10__.R, { element: "dyte-broadcast-message-modal", defaults: defaults }))));
    }
      ...
      return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-dialog", { open: true, onDyteDialogClose: () => {
        ...
        }, iconPack: this.iconPack, t: this.t }, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_37247bff_js__WEBPACK_IMPORTED_MODULE_10__.R, { element: "dyte-mute-all-confirmation", defaults: defaults }))));
    }
    else if (states === null || states === void 0 ? void 0 : states.activeChannelCreator) {
      return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-dialog", { open: true, onDyteDialogClose: () => {
          this.onDyteDialogClose('activeChannelCreator', false);
        }, iconPack: this.iconPack, t: this.t }, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_37247bff_js__WEBPACK_IMPORTED_MODULE_10__.R, { element: "dyte-channel-creator", defaults: defaults }))));
    }
    return null;
  }
};
...
const DyteNotification = class {
  ...
  render() {
    return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "ctr" }, this.notification.icon != null && ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { class: "icon", icon: this.notification.icon, iconPack: this.iconPack, t: this.t })), this.notification.image != null &&
      ...
      this.imageState !== 'errored' && ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("img", { src: this.notification.image, class: { loaded: this.imageState === 'loaded' }, onLoad: () => (this.imageState = 'loaded'), onError: () => (this.imageState = 'errored') })), (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { class: "message" }, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_TextMessage_0a552b96_js__WEBPACK_IMPORTED_MODULE_6__.T, { message: this.notification.message })), (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "right" }, this.notification.button != null && ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { size: "sm", variant: this.notification.button.variant, onClick: () => this.notification.button.onClick(), iconPack: this.iconPack, t: this.t }, this.notification.button.text)), (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { "aria-label": this.t('dismiss'), class: "dismiss", icon: this.iconPack.dismiss, onClick: () => this.dismiss.emit(this.notification.id), iconPack: this.iconPack, t: this.t })))));
  }
  static get watchers() { return {
...
const DyteNotifications = class {
  ...
  meetingChanged(meeting, oldMeeting) {
    ...
    this.chatUpdateListener = ({ message }) => {
      const parsedMessage = (0,_chat_5adf403f_js__WEBPACK_IMPORTED_MODULE_7__.p)(message);
