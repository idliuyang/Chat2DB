...
/* harmony import */ var _breakout_rooms_49baca94_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(74912);
...
const DyteBreakoutRoomManager = class {
  ...
  connectedCallback() {
    var _a;
    this.allParticipants = (0,_breakout_rooms_49baca94_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.meeting);
  ...
  renderPeer(participant) {
    const { displayPictureUrl: picture } = this.allParticipants.find((p) => (0,_breakout_rooms_49baca94_js__WEBPACK_IMPORTED_MODULE_3__.p)(p) === (0,_breakout_rooms_49baca94_js__WEBPACK_IMPORTED_MODULE_3__.p)(participant));
    const name = (0,_string_8aa800b0_js__WEBPACK_IMPORTED_MODULE_8__.f)(participant.displayName || '');
    return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "peer-ui-container" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-avatar", { participant: { name, picture }, size: "sm" }), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { class: "name", title: name }, (0,_string_8aa800b0_js__WEBPACK_IMPORTED_MODULE_8__.s)(name, 16), this.meeting.self.userId === participant.id && ` (${this.t('you')})`)));
  }
...
const DyteBreakoutRoomParticipants = class {
  constructor(hostRef) {
    ...
    this.onClick = (participant) => {
      const selected = this.selectedParticipantIds.includes((0,_breakout_rooms_49baca94_js__WEBPACK_IMPORTED_MODULE_3__.p)(participant));
      this.updateSelectedParticipants(participant, !selected);
    };
    this.onToggleAll = (checked) => {
      const selectedParticipants = checked ? this.participantsToShow.map(_breakout_rooms_49baca94_js__WEBPACK_IMPORTED_MODULE_3__.p) : [];
  ...
  updateSelectedParticipants(participant, selected) {
    const id = (0,_breakout_rooms_49baca94_js__WEBPACK_IMPORTED_MODULE_3__.p)(participant);
  ...
  getParticipants(search) {
    const allParticipants = (0,_breakout_rooms_49baca94_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.meeting);
    this.participantsToShow = allParticipants.filter((participant) => {
      var _a;
      return (this.participantIds.includes((0,_breakout_rooms_49baca94_js__WEBPACK_IMPORTED_MODULE_3__.p)(participant)) &&
  ...
  renderPeer(participant) {
    ...
    return ((0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "peer-ui-container" }, (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-avatar", { participant: {
      ...
      }, size: "sm" }), (0,_index_fe685ee5_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { class: "name", title: name }, (0,_string_8aa800b0_js__WEBPACK_IMPORTED_MODULE_8__.s)(name, 16), this.meeting.self.userId === participant.id && ` (${this.t('you')})`)));
  }
  render() {
